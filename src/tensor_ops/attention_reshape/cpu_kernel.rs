...
impl super::AttentionReshapeKernel<f32> for Cpu {
    ...
    >(
        &self,
        qkv: &Tensor<(Dyn<S>, Const<THREE_HIDDEN_DIM>), f32, Self>,
        ...
        (
            Tensor<(Const<NUM_HEADS>, Dyn<S>, Const<HEAD_DIM>), f32, Self>,
    ...
    > {
        ...
        let mut q: Tensor<(Const<NUM_HEADS>, Dyn<S>, Const<HEAD_DIM>), f32, Self, NoneTape> =
    ...
    >(
        &self,
        grad_inp: (
            &mut Self::Storage<(Const<NUM_HEADS>, Dyn<S>, Const<HEAD_DIM>), f32>,
            &mut Self::Storage<(Const<NUM_HEADS>, Const<HEAD_DIM>, usize), f32>,
            &mut Self::Storage<(Const<NUM_HEADS>, usize, Const<HEAD_DIM>), f32>,
        ),
        grad_out: (
            &Self::Storage<(Dyn<S>, Const<THREE_HIDDEN_DIM>), f32>,
            &Self::Storage<(Const<NUM_HEADS>, Const<HEAD_DIM>, usize), f32>,
            &Self::Storage<(Const<NUM_HEADS>, usize, Const<HEAD_DIM>), f32>,
        ),
    ) -> Result<(), Self::Err> {
        todo!()
    }
